(function($) {
  ...
  $.labelSelect = function(element, options) {

    var defaults = {
      activeClass: 'label-success',
      inactiveClass: 'label-default',
      elementType: 'span',
      tabElements: [],
      selectedTabs: [],
  ...
  $.fn.labelSelect = function(options) {
    return this.each(function() {
      if (undefined == $(this).data('labelSelect')) {
        var plugin = new $.labelSelect(this, options);
        $(this).data('labelSelect', plugin);
      }
    });
  }
